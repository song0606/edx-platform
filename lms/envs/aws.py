...
ENTERPRISE_REPORTING_VERTICA_HOST = ENV_TOKENS.get(
    'ENTERPRISE_REPORTING_VERTICA_HOST',
    ENTERPRISE_REPORTING_VERTICA_HOST
)
ENTERPRISE_REPORTING_VERTICA_USERNAME = ENV_TOKENS.get(
    'ENTERPRISE_REPORTING_VERTICA_USERNAME',
    ENTERPRISE_REPORTING_VERTICA_USERNAME
)
ENTERPRISE_REPORTING_VERTICA_PASSWORD = ENV_TOKENS.get(
