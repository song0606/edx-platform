...
def program_marketing(request, program_uuid):
    ...
    context = {
        ...
        'program':{
            ...
            'discount_data':{
                'is_discounted':True,
                'total_incl_tax_excl_discounts': 100.00,
            ...
            'courses':[
                {
                    'owners': [],
                    'uuid': 'f5fd9e9b-6add-4c55-b779-2eb937eb2bdf',
                    'title': 'edX Demonstration Course',
                    'image': None,
                    'key': 'edX+DemoX',
                    'short_description': "Develop your leadership skills as you learn the importance of self-efficacy, social capital, and leadership style.",
                    'course_runs': [
                        {
                            ...
                            'seats': [{
                                ...
                                'price': '149.00',
                                'currency': 'USD',
                                'upgrade_deadline': '2018-09-01T19:18:56.264586Z',
                                'credit_provider': None,
                                'type': 'verified',
                                }],
                            'course_url': '/courses/course-v1:edX+DemoX+Demo_Course/',
                            'end': None,
                            'uuid': '87b6afc1-4728-4a98-8564-3ec93a276412',
                            'title': 'edX Demonstration Course',
                            'can_enroll': True,
